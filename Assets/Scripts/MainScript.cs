...
public class MainScript : MonoBehaviour, IEventSystemHandler
{
    ...
    private String[] characterList = new string[] { "ManInSuit", "BusinessWomanPFB", "TestMale", "Luffy", "FitFemale", "Jiraiya", "YodaRigged", "BusinessMale", "BusinessFemale", "SmartMale", "UnityChan", "SmartFemale" };
